...
export default function CreateCircleChat({ onCreated }: Props) {
    ...
    messages: [
      {
        id: "greeting",
        role: "assistant",
        parts: [{ type: "text", text: "Hey! Let's set up your circle. What would you like to call it?" }],
      },
    ],
  })
    ...
    return (
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Link href={createdCircle.slug}>
            <Button variant="accent">Open {createdCircle.name}</Button>
          </Link>
        </DialogFooter>
      </DialogContent>
    )
  ...
  return (
    <DialogContent className="flex max-h-[80vh] flex-col">
      ...
      <div ref={scrollRef} className="flex min-h-[200px] flex-1 flex-col gap-3 overflow-y-auto py-4">
